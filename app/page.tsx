      ...
      <section className="relative flex min-h-[80vh] items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
            BK Streaming est votre plateforme privée de contenus vidéo en
            direct et à la demande. Sécurisée. Moderne. Pensée pour vous.
          </p>
      ...
      {live && (
        <section className="mx-auto max-w-7xl px-4 py-16">
          <div className="mb-8 flex items-center gap-3">
            ...
            <span className="animate-pulse-live rounded-full bg-bk-red px-2 py-0.5 text-xs font-bold text-white">
              LIVE
            </span>
          </div>
          ...
          >
            <div className="relative aspect-video bg-bk-dark-light">
              {live.thumbnail_url ? (
                <Image
                  src={live.thumbnail_url}
                  alt={live.title || 'Diffusion en direct'}
                  fill
      ...
      {videos && videos.length > 0 && (
        <section className="mx-auto max-w-7xl px-4 py-16">
          <div className="mb-8 flex items-center justify-between">
            ...
            <Link
              href="/videos"
              className="text-sm text-bk-red hover:underline"
            >
              Voir tout
            </Link>
          </div>
            ...
            {[
              {
                ...
                desc: 'Inscrivez-vous en quelques secondes.',
              },
              {
                icon: Shield,
                title: 'Obtenir l’accès',
                desc: 'Votre compte est validé par un administrateur.',
              },
              {
                icon: Play,
                title: 'Se connecter',
              ...
              },
              {
                icon: Zap,
                title: 'Regarder',
                desc: 'Profitez des contenus en direct et à la demande.',
              },
            ].map((step, index) => {
